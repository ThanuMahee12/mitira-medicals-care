...
<div class="container-fluid">
    <div class="row border-bottom-1 border-secondary">
        ...
        <div class="col-md-4 d-flex flex-column align-items-center text-center mt-4"><i class="fas fa-hospital"></i><a href="" class="text-decoration-none text-white h5" target="_blank">No,02,RajaVeethy,</br>Nallur,</br>Jaffna</a></div>  
    </div>
